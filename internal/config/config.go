...
func setDefaults(v *viper.Viper) {
	...
	// Scheduler
	v.SetDefault("scheduler.backend", "redis") // "redis" or "database"
...
func bindEnvVars(v *viper.Viper) {
	...
	// Scheduler
	_ = v.BindEnv("scheduler.backend", "SCHEDULER_BACKEND")
	...
	_ = v.BindEnv("scheduler.max_concurrent_export_polls", "SCHEDULER_MAX_CONCURRENT_EXPORT_POLLS")
